"""
helpers.py — External intelligence sources for ThreatLens.
...
def _get_secret(key: str) -> str | None:
    """Read a secret without letting a missing secrets.toml crash the app."""
    try:
...
def get_virustotal(target_type: str, target: str) -> dict:
    ...
    if not api_key:
        return _error("VirusTotal", "VirusTotal API key is not configured.")
